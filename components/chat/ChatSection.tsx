...
export function ChatSection({ dict, getCvData, onApplySuggestion, language, jobDescription, onJobDescriptionChange }: Props) {
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-on-surface font-headline-md font-bold text-lg flex items-center gap-2">
          <svg className="w-5 h-5 text-tertiary" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2a4 4 0 0 1 4 4c0 1.3-.6 2.4-1.5 3.1A9 9 0 0 1 21 17a1 1 0 0 1-2 0 7 7 0 0 0-14 0 1 1 0 0 1-2 0 9 9 0 0 1 6.5-7.9A4 4 0 0 1 8 6a4 4 0 0 1 4-4z" />
          </svg>
          {dict.chat.title}
        </h3>
        <button
